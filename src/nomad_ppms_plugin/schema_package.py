...
from nomad_ppms_plugin.cpfsppmsdatastruct import (
    ...
    CPFSPPMSResistivityMeasurement,
    CPFSSample,
)
...
configuration = config.get_plugin_entry_point('nomad_ppms_plugin:eto_schema_default')
configuration = config.get_plugin_entry_point('nomad_ppms_plugin:eto_schema_labview')
configuration = config.get_plugin_entry_point('nomad_ppms_plugin:act_schema_default')
configuration = config.get_plugin_entry_point('nomad_ppms_plugin:mpms_schema_default')
configuration = config.get_plugin_entry_point('nomad_ppms_plugin:acms_schema_default')
configuration = config.get_plugin_entry_point(
    'nomad_ppms_plugin:resistivity_schema_default'
)
...
m_package_ppms_resistivity_default = SchemaPackage()


class CPFSPPMSResistivityMeasurementDefault(
...
m_package_ppms_resistivity_default.__init_metainfo__()
